...
function getNumStars(state) {
    ...
    if (rating > 8) { return 5; } else if (rating <= 8 && rating > 6) { return 4; } else if (rating <= 6 && rating > 4) { return 3; } else if (rating <= 4 && rating > 2) { return 2; } else if (rating === 0) { return 2; } else { return 1; }
}
